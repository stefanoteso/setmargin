...
\begin{figure}[b]
    ...
    \begin{tabular}{cccc}
        \hline
        {\sc synthetic 3} & {\sc synthetic 4} & {\sc synthetic 5} & {\sc synthetic 6}
        \\
        \hline \hline
        \multicolumn{4}{c}{{\sc Uniform}}
        \\
        \includegraphics[width=10em]{figures/synthetic_3_uniform_per_iter_loss} &
        \includegraphics[width=10em]{figures/synthetic_4_uniform_per_iter_loss} &
        \includegraphics[width=10em]{figures/synthetic_5_uniform_per_iter_loss} &
        \includegraphics[width=10em]{figures/synthetic_6_uniform_per_iter_loss}
        \\
        \hline
        \multicolumn{4}{c}{{\sc Uniform Sparse}}
        \\
        \includegraphics[width=10em]{figures/synthetic_3_uniform_sparse_per_iter_loss} &
        \includegraphics[width=10em]{figures/synthetic_4_uniform_sparse_per_iter_loss} &
        \includegraphics[width=10em]{figures/synthetic_5_uniform_sparse_per_iter_loss} &
        \includegraphics[width=10em]{figures/synthetic_6_uniform_sparse_per_iter_loss}
        \\
        \hline
        \multicolumn{4}{c}{{\sc Normal}}
        \\
        \includegraphics[width=10em]{figures/synthetic_3_normal_per_iter_loss} &
        \includegraphics[width=10em]{figures/synthetic_4_normal_per_iter_loss} &
        \includegraphics[width=10em]{figures/synthetic_5_normal_per_iter_loss} &
        \includegraphics[width=10em]{figures/synthetic_6_normal_per_iter_loss}
        \\
        \hline
        \multicolumn{4}{c}{{\sc Normal Sparse}}
        \\
        \includegraphics[width=10em]{figures/synthetic_3_normal_sparse_per_iter_loss} &
        \includegraphics[width=10em]{figures/synthetic_4_normal_sparse_per_iter_loss} &
        \includegraphics[width=10em]{figures/synthetic_5_normal_sparse_per_iter_loss} &
        \includegraphics[width=10em]{figures/synthetic_6_normal_sparse_per_iter_loss}
        \\
        \hline
    \end{tabular}
    }
...
\begin{figure}[b]
    ...
    \begin{tabular}{cccc}
        ...
        \multicolumn{4}{c}{{\sc Uniform}}
        \\
        \includegraphics[width=10em]{figures/synthetic_3_uniform_per_query_loss} &
        \includegraphics[width=10em]{figures/synthetic_4_uniform_per_query_loss} &
        \includegraphics[width=10em]{figures/synthetic_5_uniform_per_query_loss} &
        \includegraphics[width=10em]{figures/synthetic_6_uniform_per_query_loss}
        \\
        \hline
        \multicolumn{4}{c}{{\sc Uniform Sparse}}
        \\
        \includegraphics[width=10em]{figures/synthetic_3_uniform_sparse_per_query_loss} &
        \includegraphics[width=10em]{figures/synthetic_4_uniform_sparse_per_query_loss} &
        \includegraphics[width=10em]{figures/synthetic_5_uniform_sparse_per_query_loss} &
        \includegraphics[width=10em]{figures/synthetic_6_uniform_sparse_per_query_loss}
        \\
        \hline
        \multicolumn{4}{c}{{\sc Normal}}
        \\
        \includegraphics[width=10em]{figures/synthetic_3_normal_per_query_loss} &
        \includegraphics[width=10em]{figures/synthetic_4_normal_per_query_loss} &
        \includegraphics[width=10em]{figures/synthetic_5_normal_per_query_loss} &
        \includegraphics[width=10em]{figures/synthetic_6_normal_per_query_loss}
        \\
        \hline
        \multicolumn{4}{c}{{\sc Normal Sparse}}
        \\
        \includegraphics[width=10em]{figures/synthetic_3_normal_sparse_per_query_loss} &
        \includegraphics[width=10em]{figures/synthetic_4_normal_sparse_per_query_loss} &
        \includegraphics[width=10em]{figures/synthetic_5_normal_sparse_per_query_loss} &
        \includegraphics[width=10em]{figures/synthetic_6_normal_sparse_per_query_loss}
        \\
        \hline
    \end{tabular}
    }
...
\begin{figure}[b]
    ...
    \begin{tabular}{cccc}
        ...
        \multicolumn{4}{c}{{\sc Uniform}}
        \\
        \includegraphics[width=10em]{figures/synthetic_3_uniform_per_iter_time} &
        \includegraphics[width=10em]{figures/synthetic_4_uniform_per_iter_time} &
        \includegraphics[width=10em]{figures/synthetic_5_uniform_per_iter_time} &
        \includegraphics[width=10em]{figures/synthetic_6_uniform_per_iter_time}
        \\
        \hline
        \multicolumn{4}{c}{{\sc Uniform Sparse}}
        \\
        \includegraphics[width=10em]{figures/synthetic_3_uniform_sparse_per_iter_time} &
        \includegraphics[width=10em]{figures/synthetic_4_uniform_sparse_per_iter_time} &
        \includegraphics[width=10em]{figures/synthetic_5_uniform_sparse_per_iter_time} &
        \includegraphics[width=10em]{figures/synthetic_6_uniform_sparse_per_iter_time}
        \\
        \hline
        \multicolumn{4}{c}{{\sc Normal}}
        \\
        \includegraphics[width=10em]{figures/synthetic_3_normal_per_iter_time} &
        \includegraphics[width=10em]{figures/synthetic_4_normal_per_iter_time} &
        \includegraphics[width=10em]{figures/synthetic_5_normal_per_iter_time} &
        \includegraphics[width=10em]{figures/synthetic_6_normal_per_iter_time}
        \\
        \hline
        \multicolumn{4}{c}{{\sc Normal Sparse}}
        \\
        \includegraphics[width=10em]{figures/synthetic_3_normal_sparse_per_iter_time} &
        \includegraphics[width=10em]{figures/synthetic_4_normal_sparse_per_iter_time} &
        \includegraphics[width=10em]{figures/synthetic_5_normal_sparse_per_iter_time} &
        \includegraphics[width=10em]{figures/synthetic_6_normal_sparse_per_iter_time}
        \\
        \hline
    \end{tabular}
    }
...
\begin{figure}[b]
    ...
    \begin{tabular}{cccc}
        ...
        \multicolumn{4}{c}{{\sc Uniform}}
        \\
        \includegraphics[width=10em]{figures/synthetic_3_uniform_per_query_time} &
        \includegraphics[width=10em]{figures/synthetic_4_uniform_per_query_time} &
        \includegraphics[width=10em]{figures/synthetic_5_uniform_per_query_time} &
        \includegraphics[width=10em]{figures/synthetic_6_uniform_per_query_time}
        \\
        \hline
        \multicolumn{4}{c}{{\sc Uniform Sparse}}
        \\
        \includegraphics[width=10em]{figures/synthetic_3_uniform_sparse_per_query_time} &
        \includegraphics[width=10em]{figures/synthetic_4_uniform_sparse_per_query_time} &
        \includegraphics[width=10em]{figures/synthetic_5_uniform_sparse_per_query_time} &
        \includegraphics[width=10em]{figures/synthetic_6_uniform_sparse_per_query_time}
        \\
        \hline
        \multicolumn{4}{c}{{\sc Normal}}
        \\
        \includegraphics[width=10em]{figures/synthetic_3_normal_per_query_time} &
        \includegraphics[width=10em]{figures/synthetic_4_normal_per_query_time} &
        \includegraphics[width=10em]{figures/synthetic_5_normal_per_query_time} &
        \includegraphics[width=10em]{figures/synthetic_6_normal_per_query_time}
        \\
        \hline
        \multicolumn{4}{c}{{\sc Normal Sparse}}
        \\
        \includegraphics[width=10em]{figures/synthetic_3_normal_sparse_per_query_time} &
        \includegraphics[width=10em]{figures/synthetic_4_normal_sparse_per_query_time} &
        \includegraphics[width=10em]{figures/synthetic_5_normal_sparse_per_query_time} &
        \includegraphics[width=10em]{figures/synthetic_6_normal_sparse_per_query_time}
        \\
        \hline
    \end{tabular}
    }
