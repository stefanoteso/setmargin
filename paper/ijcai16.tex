...
% \footnote{When experiment with EUS and QI, the user is forced to select
% its preffered item, so indifference is not possible. While support for indifference
% could be added, we chose to .}
