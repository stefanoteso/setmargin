...
\paolo{The automated assessment of preferences has received considerable attention,
starting with pioneering works in the OR community, such as \cite{White1984} and especially the UTA methodology \cite{jaquetlsiskos1982} giving rise to a wide variety of extensions \cite{jaquetlsiskos2001,greco2008ordinal}.}
...
Consistently with \paolo{the experimental settings} of previous work~\cite{guo2010real,viappiani2010optimal}, 
...
\paolo{in a way similar to UTA and its extensions \cite{jaquetlsiskos1982,greco2008ordinal} }. When
...
The second goal requires \stefano{I think this is correct as-is: the second
reviewer thinks that the second goal is to maximize diversity; above we clearly
state that it requires to find diverse {\em and} good configurations} to jointly maximize the utility of each
...
\url{https://db.tt/oqY62odW} \stefano{update the link!}.
