...
\begin{align}
    ...
    \\
        & \;\; \forall \; i \in [k] \quad \vx^{i} \in \calX_{\text{feasible}} \;\;, \veps^{i} \ge 0 \label{eq:xbounds}
%    \\
...
that the weights and configurations are feasible
%, while the last one
and
...
\begin{align}
    ...
    \\
        & \;\; \forall \; i \in [k] \quad \vx^{i} \in \calX_{\text{feasible}} \;, \veps^{i} \ge 0 \nonumber
%    \\
...
in~\cite{guo2010real}
%\footnote{We used the parameters implemented in their code, which are slightly different from those reported in the paper.}%
...
applicability to other problems, as the identification of Choquet models
\cite{Pine2013}.
