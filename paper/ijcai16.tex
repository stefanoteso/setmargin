...
%
%\paolo{Maybe a plot of an experiment with increased noise in user reponse? (for example, $\beta=0.1$ instead of $1$.}
%
...
terms of cumulative time. Given that Guo and Viappiani (both QI and EUS) are
...
\begin{figure}[b]
    ...
    \caption{\label{fig:comparison} Comparison between {\sc SetMargin}
      ...
      (green) and Viappiani EUS (gray) respectively. \andrea{@stefano remove median and average from y-axis}}
\end{figure}
