...
%The problem is that of learning or assessing the preferences of the user (or decision maker).
...
%\andrea{other constructive preference elicitation approaches?}
...
% \paolo{I would remove the last sentence}
% 
