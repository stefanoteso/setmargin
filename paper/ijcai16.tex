...
\andrea{mmh sembra che gestiamo solo booleani.. riscriverei che ci concentriamo solo su feature categoriche, e 
che le rappresentiamo con one-hot encoding come tipico dei metodi preference elicitation..}
...
\begin{align}
    ...
    \\
        & \;\; M \ge 0 \nonumber
\end{align}
} \andrea{perche' un punto tra il quantificatore e la formula? inoltre mi sa che ``n'' e' usato per due cose, queries e features}
%
