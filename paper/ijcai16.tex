...
measured in terms of utility loss:
%
...
fraction of their time.  Indeed, all Bayesian approaches\footnote{Note
  that for {\sc QI} and {\sc EUS}, the time spent for Bayesian
  inference greatly dominates the time spent for choosing the next
  query to ask.\andrea{@paolo: necessario?}} become quickly intractable for growing values of $r$,
