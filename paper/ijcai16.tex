...
of the mutual exclusivity constraints of the one-hot encoding.  The
dataset includes constraints between the following attributes:
...
limitations. Note that the search space is of the order of hundreds of
thousands of candidate configurations, and is far beyond reach of
