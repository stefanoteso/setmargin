...
Max-margin learning has been proposed before \cite{gajos2005} for preference elicitation, but with  rudimental methods for query selection.
%We adopt the idea of max-margin learning (while it has been proposed before \cite{gajos2005}, their methods query generation were rather rudimental) for preference elicitation.
...
red line; moreover the vector $\vw^{1}$ will maximize the margin in the classic ($k=1$) sense in new feasible region.
...
applicability %of the setwise max-margin idea 
to other problems.
