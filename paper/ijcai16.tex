...
\begin{itemize}
\item The best Bayesian approach from \cite{guo2010real}, selecting
  queries according to {\em restricted informed VOI} ({\sc riVOI}), a
  heuristic approximation (equally effective but more efficient) of
...
uniformly at random). All methods were evaluated on the same weight
vectors. All users had a budget of 100 iterations; for {\sc SetMargin}
